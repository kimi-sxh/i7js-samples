...
public class Listing_11_19_FontFactory extends GenericTest {
    ...
    protected void manipulatePdf(String dest) throws Exception {
        ...
        for (String f : FontProgramFactory.getRegisteredFonts()) {
            doc.add(new Paragraph(f).setFont(PdfFontFactory.createRegisteredFont(f, "", PdfFontFactory.EmbeddingStrategy.PREFER_EMBEDDED)));
        }
        doc.add(new Paragraph("\n"));

        PdfFont cmr10 = PdfFontFactory.createRegisteredFont("cmr10", FontEncoding.FONT_SPECIFIC, PdfFontFactory.EmbeddingStrategy.PREFER_EMBEDDED);
        ...
        PdfFont garamond = PdfFontFactory.createRegisteredFont("EB Garamond", PdfEncodings.WINANSI, PdfFontFactory.EmbeddingStrategy.PREFER_EMBEDDED);
        doc.add(new Paragraph("EB Garamond").setFont(garamond));
        PdfFont garamondItalic = PdfFontFactory.createRegisteredFont("EB Garamond", PdfEncodings.WINANSI, PdfFontFactory.EmbeddingStrategy.PREFER_EMBEDDED, FontStyles.ITALIC);
